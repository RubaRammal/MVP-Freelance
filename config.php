...
define('BASE_URL','http://localhost/AhemdVer/'); // always include the trailing slash at the end // Changed base url, Ruba Rammal, 19/08/2019 
...
define('API_LOGIN_NODE','Authentication');
define('API_TEACHINGSTAFF_NODE','TeachingStaffs');
