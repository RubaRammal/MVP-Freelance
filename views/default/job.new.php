...
<div class="row">
  ...
  <div class="col-md-12">
      ...
      <form  role="form" action="<?php _e(USER_URL); ?>jobs/review" method="post" enctype="multipart/form-data">
        ...
        <label for="logo" class="col-sm-3 control-label input-lg"><?php echo $lang->t('jobs|logo'); ?></label>
            <div class="col-sm-12 col-md-8">
              <div class="custom-file">
                ...
                <label class="custom-file-label" for="customFile" id="custom-logo"></label>
              </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="text-center">
              ...
              <input type="submit" class="btn btn-success btn-lg all-btns job-btn float-left" value="<?php echo $lang->t('jobs|btn_review'); ?>" />
              </div>
            </div>
           </div>
        </div>
