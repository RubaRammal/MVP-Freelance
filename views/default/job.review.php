...
<div class="row">
  <div class="col-md-12">
      ...
      <form class="form-horizontal" role="form" action="<?php _e(USER_URL . "jobs/{$job->id}/publish/{$job->token}"); ?>" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <h3 class="text-center">
                <span class="badge badge-secondary"><?php echo $lang->t('jobs|step1'); ?></span>
                <span class="badge badge-info"><?php echo $lang->t('jobs|step2'); ?></span>
...
<!-- 
                ...
                <div class="form-group">
                    <div class="text-center">
                        ...
                        <input type="submit" class="btn btn-success btn-lg all-btns job-btn float-left" value="<?php echo $lang->t('jobs|btn_submit'); ?>" />
                    </div>
                </div>
            </div>
        </div>
